...
import (
	...
	"github.com/nextwavedevs/drop/app/sidecar/metrics/collector"
	"github.com/nextwavedevs/drop/app/sidecar/metrics/publisher"
	"github.com/nextwavedevs/drop/app/sidecar/metrics/publisher/expvar"
...
func run(log *log.Logger) error {
	...
	var cfg struct {
		...
		Collect struct {
			From string `conf:"default:http://drop-api:4000/debug/vars"`
		}
		Publish struct {
